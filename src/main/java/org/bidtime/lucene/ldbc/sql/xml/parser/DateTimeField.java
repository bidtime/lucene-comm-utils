...
public final class DateTimeField extends Field {
   ...
   */
  public DateTimeField(String name, long value, Store stored) {
   ...
   */
  public DateTimeField(String name, long value, FieldType type) {
    super(name, type);
  ...
  public DateTimeField(String name, Date value, FieldType type) {
	  this(name, value != null ? value.getTime() : 0, type);
  }
  
  public DateTimeField(String name, Date value, Store stored) {
	  this(name, value != null ? value.getTime() : 0, stored);
  }
